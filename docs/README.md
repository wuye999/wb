...
2. **促销报名 / 广告推广商品查询 / 推广缺口审计 / 折扣改价 / 清理 / 订单 / 买家提问 / 每日自动化**（原「促销折扣」）：`promo-apply / promo-goods / promo-gap / discount / clean / orders / feishu-vc-stats / questions / cookies-update / daily / schedule`
...
| [CLI.md](CLI.md) | 45 个子命令全集参数、示例、退出码；Python 库调用方式 |
